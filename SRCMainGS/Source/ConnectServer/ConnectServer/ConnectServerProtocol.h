...
struct PMSG_SERVER_HWID_RECV
{
	PSBMSG_HEAD header; // C1:F4:04
...
struct PMSG_SERVER_VERSION_RECV
{
	PSBMSG_HEAD header; // C1:F4:03
	WORD ClientVersion;
};
...
struct PMSG_SERVER_FILE_VERSION_SEND
{
...
struct PMSG_SERVER_VERSION_UPDATE_SEND
{
	PSWMSG_HEAD Header;
	WORD        state;
	WORD        Version;
...
void CCServerUpdateSend(int index, WORD result, WORD Version, bool accumulated = false);
