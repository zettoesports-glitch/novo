...
void CEventStart::MainProc() // OK
{
	...
	{ 
		...
		{
			gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(670),m_RemainTime);
		}
		...
		{
			    this->m_EventStart = 0;
				gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(671));
...
void CEventStart::CommandEventStart(LPOBJ lpObj,char* arg) // OK 
{
	...
	if (this->m_RemainTime > 0) 
	{
		...
		gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(672));
		return;
	}
	...
	gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(673),lpObj->Name);
	gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(674));
...
void CEventStart::CommandEventStartJoin(LPOBJ lpObj,char* arg) // OK 
{
	...
	gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(675),lpObj->Name);
