...
void CEventRussianRoulette::MainProc() // OK
{
	...
	{ 
		if(this->m_RemainTime <= (this->m_TotalTime-gServerInfo.m_EventRussianRouletteTimeToEnter) && this->m_EventRussianRouletteEnter == 1)
		{
			if (this->m_Members < 2)
			{
				gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(707));
			...
			{
				gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(704));
				gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(705));
		...
		{
			    this->m_EventRussianRouletteActive = 0;
				gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(706));
	...
	{ 
		...
		{
			gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(712));
		}

		if(this->m_RouletteRemainTime == 6)
		{
			gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(713));
		}

		if(this->m_RouletteRemainTime == 4)
		{
			gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(714));
		}
		if(this->m_RouletteRemainTime == 2)
		{
			gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(715));
		}
		...
		if(this->m_RouletteRemainTime <= 0)
		{
				...
				if((GetLargeRand()%100) <= 25)
				{
					...
					gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(716),lpObj->Name);
					LogAdd(LOG_EVENT,"[EVENT RUSSIAN ROULETTE] %s Removed",lpObj->Name);
				}
				else 
				{
					gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(717),lpObj->Name);
					LogAdd(LOG_EVENT,"[EVENT RUSSIAN ROULETTE] %s Saved",lpObj->Name);
						...
						if (this->m_Members == 1)
						{
							...
							gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(711),lpObj->Name);
...
void CEventRussianRoulette::CommandEventRussianRoulette(LPOBJ lpObj,char* arg) // OK 
{
	...
	gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(708),gServerInfo.m_EventRussianRouletteMaxPlayer);
	gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(709));
...
void CEventRussianRoulette::CommandEventRussianRouletteJoin(LPOBJ lpObj,char* arg) // OK 
{
	...
	gNotice.GCNoticeSendToAll(0,0,0,0,0,0,gMessage.GlobalText(710),this->m_Members, lpObj->Name);
