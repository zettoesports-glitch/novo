...
- [x] Re-audit the Phase 2 source and pass the final combined Release+Debug x86 gate after teardown/runtime-gate hardening (run `34540959623`, source commit `d24e117270113918d877e17abd4609cad236d92e`)
